...
| Java | `com.x_twitter_scraper.api:x-twitter-scraper-java` | [GitHub](https://github.com/Xquik-dev/x-twitter-scraper-java) |
| Kotlin | `com.x_twitter_scraper.api:x-twitter-scraper-kotlin` | [GitHub](https://github.com/Xquik-dev/x-twitter-scraper-kotlin) |
