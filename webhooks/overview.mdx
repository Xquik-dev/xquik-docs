...
| `data` | object | Raw tweet object from the X real-time stream |
...
Each event type includes a `data` object containing the raw tweet. The examples below show the most common fields.
