...
<Steps>
  ...
  <Step title="AI Agent Skill">
    Install the [Xquik Skill](https://github.com/Xquik-dev/x-twitter-scraper) to give 40+ AI coding agents (Claude Code, Cursor, Codex, Copilot, Windsurf, and more) deep knowledge of the Xquik API, MCP tools, and 111 REST endpoints. Install via `npx skills add Xquik-dev/x-twitter-scraper`.
  </Step>
