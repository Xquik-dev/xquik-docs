...
Complete-mode coverage evidence. Omitted from standard responses.
  ...
  <Expandable title="Coverage diagnostic fields">
    ...
    <ResponseField name="replyTreeComplete" type="boolean">
      Every collected reply has a known child count matching its collected children.
      The source post must also match. Omitted when confirmation is unavailable.
      Counts reflect X's response at collection time. Continue pagination while
