...
description: "Retrieve an X community's name, description, member count, creator, moderators, rules, join policy, banner, and creation time. Costs 1 credit per call."
