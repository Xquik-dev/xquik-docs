...
Use this route for the liked tweets of your connected X account. Pass that account's user ID or username as `id`. Guest keys and callers without a connected X account get `424 account_required`. Use [Connect X account](/api-reference/x-accounts/connect) to add one.
