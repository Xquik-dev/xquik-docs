...
<Info>
  **Cost:** 1 credit per tweet returned (~$0.00015 on [PAYG](/guides/billing#pay-per-use-mpp)). Also accepts [MPP](/mpp/overview) payments ($0.00015 per tweet).
</Info>
...
<CodeGroup>
  ...
  ```javascript Node.js
  const params = new URLSearchParams({ q: "from:xquikcom giveaway", limit: "50" });
  ...
  response = requests.get(
      ...
      params={"q": "from:xquikcom giveaway", "limit": 50},
      headers={"x-api-key": "xq_a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2"},
  )
  data = response.json()
  print(data)
...
<ParamField query="limit" type="integer">
  Maximum number of tweets to return. Default `20`, max `200`.
</ParamField>
