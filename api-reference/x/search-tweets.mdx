...
<CodeGroup>
  ...
  curl -G https://xquik.com/api/v1/x/tweets/search \
    --data-urlencode "q=from:burakbayir giveaway" \
    -H "x-api-key: xq_a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2" | jq
  ```

  ```javascript Node.js
  const query = encodeURIComponent("from:burakbayir giveaway");
  ...
  response = requests.get(
      ...
      params={"q": "from:burakbayir giveaway"},
      headers={"x-api-key": "xq_a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2"},
  )
  data = response.json()
  print(data)
  ...
  func main() {
  	...
  	params := url.Values{}
  	params.Set("q", "from:burakbayir giveaway")
