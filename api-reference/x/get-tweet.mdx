...
<ResponseField name="noteTweet" type="object">
    ...
    <ResponseField name="exclusiveContent" type="object">Creator whose subscription unlocks a subscriber-only post. Contains `creatorUserName`. Omitted on public posts.</ResponseField>
