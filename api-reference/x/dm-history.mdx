...
<ParamField query="maxId" type="string">
  Pagination cursor. Pass the ID of the oldest message from the previous response to fetch older messages.
</ParamField>
...
<Tabs>
  <Tab title="200 OK">
    ...
    <ResponseField name="count" type="number">Number of messages returned.</ResponseField>
