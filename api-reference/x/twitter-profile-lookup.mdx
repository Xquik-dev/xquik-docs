...
<CardGroup cols={2}>
  ...
  <Card title="Availability" icon="triangle-alert">
    ...
    Store `unavailable` and `unavailableReason` when returned. Retries,
    support triage, and CRM syncs can then distinguish missing accounts from unavailable
    profiles.
...
<CardGroup cols={2}>
  ...
  <Card title="Saved exports" icon="file-spreadsheet">
    ...
    Create saved CSV, JSON, or XLSX jobs. Export followers, following, timelines,
    media, or search.
