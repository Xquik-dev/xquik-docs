...
<Info>
  **Cost:** 7 credits per call (~$0.00105 on [PAYG](/guides/billing#pay-per-use-mpp)). Also accepts [MPP](/mpp/overview) payments ($0.00105 per call).
</Info>
...
<Tabs>
  ...
  <Tab title="404 Article not found">
    ```json
    { "error": "not_found", "message": "Article not found for the given tweet" }
    ```
