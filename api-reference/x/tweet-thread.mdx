...
description: "Retrieve the tweet thread around one tweet with authors, reply relationships, text, media, engagement metrics, and cursors. Costs 1 credit per tweet returned."
...
Numeric X tweet ID. A retweet ID returns the original post's thread.
