...
description: "Get a connected X account's home feed. Paginate tweets with authors, replies, reposts, likes, views, media, and cursors. Costs 1 credit per tweet returned."
api: "GET /x/timeline"
keywords:
  [
...
The route reads the home timeline of your connected X account. Without one, it
...
Connect an X account after `424 account_required`. Respect `Retry-After` after
429 or 503. Resume from the stored cursor after other 424 or 502 responses.
