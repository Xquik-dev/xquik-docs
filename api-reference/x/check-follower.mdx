...
<CodeGroup>
  ...
  ```javascript Node.js
  const params = new URLSearchParams({ source: "burakbayir", target: "elonmusk" });
  ...
  response = requests.get(
      ...
      params={"source": "burakbayir", "target": "elonmusk"},
      headers={"x-api-key": "xq_a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2"},
  )
  data = response.json()
  print(data)
