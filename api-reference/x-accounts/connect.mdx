...
<Tabs>
  <Tab title="201 Created">
    ...
    <ResponseField name="loginCountry" type="string">Optional ISO 3166-1 alpha-2 country code (for example `"US"`). Present only when the declared proxy region was unavailable and login used a one-time US browser session. Future activity continues to use the selected `proxy_country`. Omitted on normal logins.</ResponseField>
