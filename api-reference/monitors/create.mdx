...
<Tabs>
  ...
  <Tab title="403 Limit Reached">
    ...
    ```
    Your plan allows 1 monitor by default. Add more for $10/month each from the [dashboard](https://xquik.com/dashboard).
  </Tab>
  ...
  <Tab title="502 Stream Registration Failed">
    ...
    ```
    Failed to register the monitor with the upstream streaming service. Try again later.
  </Tab>
</Tabs>
