---
title: "Xquik support ticket API for request media uploads"
...
1 standard byte range for video seeking or resumable downloads. Example: `bytes=0-1048575`.
...
Video downloads support 1 standard byte range. Use ranges for seeking or resumable playback.
