...
description: "Save 1-100 approved tweet examples as a reusable writing profile under one lowercase label. Saving the same label replaces every example. The call is free."
api: "PUT /styles/{id}"
keywords:
  [
    "tweet writing",
