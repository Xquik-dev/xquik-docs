...
description: "Save a custom style profile from tweet texts"
api: "PUT /styles/{username}"
...
<ParamField path="username" type="string" required>
  Style label used as the identifier. 1-30 characters. This becomes the key for retrieving the style later.
</ParamField>
