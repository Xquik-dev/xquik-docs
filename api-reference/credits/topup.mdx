...
description: "Create a hosted checkout for at least USD 10 of tweet, profile, follower, monitor, webhook, export, and X write API credits. Returns one redirect URL."
