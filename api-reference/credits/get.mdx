...
description: "Retrieve the available API credit balance, lifetime purchased and used totals, and automatic top-up settings for an Xquik account. The call is free to run."
api: "GET /credits"
