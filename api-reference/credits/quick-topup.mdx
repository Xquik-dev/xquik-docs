...
<Tabs>
  <Tab title="200 Charged">
    ...
    <ResponseField name="balance" type="number">Updated credit balance after top-up.</ResponseField>
    <ResponseField name="credits" type="number">Number of credits added.</ResponseField>
