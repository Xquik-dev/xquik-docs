...
No saved payment method on file. Redirect the user to add one in the billing portal, or use the standard [top-up endpoint](/api-reference/credits/topup) instead.
