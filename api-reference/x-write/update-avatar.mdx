...
<ParamField body="file" type="binary" required>
  The image file to upload. Accepted formats: GIF, JPEG, PNG. Maximum file size: 700 KB.
</ParamField>
...
<Tabs>
  ...
  <Tab title="400 Invalid Input">
    ...
    ```
    The file is not a supported format (GIF, JPEG, PNG) or exceeds the 700 KB limit.
  </Tab>
