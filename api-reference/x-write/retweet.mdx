...
<Note>
  **Related:** [Like Tweet](/api-reference/x-write/like) to like a tweet, [Unlike Tweet](/api-reference/x-write/unlike) to remove a like, or [Create Tweet](/api-reference/x-write/create-tweet) to post an original tweet.
</Note>
