...
<Tabs>
  <Tab title="200 OK">
    <ResponseField name="mediaId" type="string">The uploaded media ID. Supply it in the `media_ids` array on `POST /x/dm/id` when sending a direct message with media.</ResponseField>
