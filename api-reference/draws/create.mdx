...
The available balance cannot cover the minimum draw cost. A later final deduction failure also returns `insufficient_credits`. Xquik persists no draw result after that failure. Check your [credit balance](/api-reference/account/get).
