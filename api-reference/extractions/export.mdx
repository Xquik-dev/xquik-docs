...
description: "Export tweet, follower, reply, profile, timeline, community, or list results in 7 formats, with documented CSV, XLSX, JSON, and PDF limits. Exports are free."
...
<CardGroup cols={2}>
  ...
  <Card title="Analyst XLSX" icon="file-spreadsheet">
    ...
    people need filters or formulas.
...
<Tabs>
  ...
  <Tab title="200 OK">
    ...
    Exports stop at 100,000 rows (10,000 for PDF). For extractions with more results, the export includes the first 100,000 rows ordered by result ID.
