...
<Tabs>
  <Tab title="200 OK">
    ...
    |--------|-------------|-----------------|
    | `csv` | `text/csv; charset=utf-8` | `extraction-reply_extractor-*.csv` |
    | `json` | `application/json; charset=utf-8` | `extraction-reply_extractor-*.json` |
    | `md` | `text/markdown; charset=utf-8` | `extraction-reply_extractor-*.md` |
    | `md-document` | `text/markdown; charset=utf-8` | `extraction-reply_extractor-*.md` |
    | `pdf` | `application/pdf` | `extraction-reply_extractor-*.pdf` |
    | `txt` | `text/plain; charset=utf-8` | `extraction-reply_extractor-*.txt` |
    | `xlsx` | `application/vnd.openxmlformats-officedocument.spreadsheetml.sheet` | `extraction-reply_extractor-*.xlsx` |
