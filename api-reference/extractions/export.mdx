...
Enrichment data (Following, Posts, Description, Location) is collected automatically during extraction. These columns may be empty if the X API did not return the data for a given user.
