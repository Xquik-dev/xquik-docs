  ...
  <Tab title="200 OK">
    <ResponseField name="job" type="object">
      ...
      <Expandable title="Job object properties">
        ...
        <ResponseField name="targetListId" type="string">Target list ID. Present for `list_member_extractor`, `list_post_extractor`, `list_follower_explorer`.</ResponseField>
        <ResponseField name="targetSpaceId" type="string">Target Space ID. Present for `space_explorer`.</ResponseField>
    ...
    <Tip>
      The API response includes core profile and tweet fields. Additional enrichment data -- profile descriptions, locations, tweet engagement metrics, and more -- is available through [Export Extraction](/api-reference/extractions/export) in CSV, XLSX, or Markdown format.
    </Tip>
