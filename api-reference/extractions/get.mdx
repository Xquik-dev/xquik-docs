...
<Tabs>
  <Tab title="200 OK">
    ...
    <ResponseField name="results" type="object[]">
      ...
      <Info>
        Only `id` and `xUserId` are guaranteed on every result. All other fields are **omitted entirely** when unavailable -- they are not set to `null`. Always check for the presence of a field before accessing it.
      </Info>
