...
<ParamField body="exactPhrase" type="string">
  Require an exact phrase match in tweet text.
</ParamField>
...
<ParamField body="advancedQuery" type="string">
  Raw X search operator syntax appended to the query. Use for advanced combinations not covered by the other filters.
</ParamField>
