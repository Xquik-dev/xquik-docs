...
<ParamField query="toolType" type="string">
  Filter by tool type. One of: `reply_extractor`, `like_extractor`, `retweet_extractor`, `community_explorer`, `mention_tracker`, `follower_extractor`, `following_extractor`, `search_results`.
</ParamField>
