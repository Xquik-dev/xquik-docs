...
description: "Test and resume a paused webhook after delivery failures. Xquik sends a signed test and reactivates the webhook only after a 2xx response. The call is free."
