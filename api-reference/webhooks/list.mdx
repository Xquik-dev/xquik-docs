...
| Delivery status          | `webhooks[].deliveryStatus`      | Send needs-attention receivers to recovery.     |
...
<CardGroup cols={2}>
  ...
  <Card title="Delivery status" icon="radio">
    ...
    [Resume Webhook](/api-reference/webhooks/resume) after you fix the receiver.
