...
Every subscriber gets a monthly credit allowance. Credits are deducted per API call (1-10 credits depending on the operation). Check `creditInfo.balance` to track remaining capacity. At 0, metered API calls return `402` until you top up credits.
