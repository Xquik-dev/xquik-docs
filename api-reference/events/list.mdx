...
<ParamField query="eventType" type="string">
  Filter by event type: `tweet.new`, `tweet.reply`, `tweet.quote`, `tweet.retweet`, `follower.gained`, `follower.lost`. Omit to return all types.
</ParamField>
    ...
    <ResponseField name="events" type="array">
      ...
      <Expandable title="event object">
        ...
        <ResponseField name="type" type="string">
          Event type (`tweet.new`, `tweet.reply`, `tweet.quote`, `tweet.retweet`, `follower.gained`, `follower.lost`).
        </ResponseField>
