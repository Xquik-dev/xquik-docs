    ...
    <ResponseField name="events" type="array">
      ...
      <Expandable title="event object">
        ...
        <ResponseField name="data" type="object">
          Event-specific payload. The structure of this object **varies by event type**.

          <Info>
            The `data` field contains opaque JSON whose shape depends on the `type` of the event. For example, `tweet.new` events include tweet text and engagement metrics, while `tweet.reply` events include additional reply context. See [Webhooks Overview](/webhooks/overview) for the full data schema of each event type.
          </Info>
        </ResponseField>
      </Expandable>
    </ResponseField>
