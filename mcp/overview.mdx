...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 119 individual endpoints |
...
Works with 40+ AI coding agents including Claude Code, Cursor, GitHub Copilot, Codex, Windsurf, VS Code, Gemini CLI, and more. The skill covers MCP tools and 119 REST API endpoints.
