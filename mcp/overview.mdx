...
| **Auth** | `x-api-key` header during MCP handshake | `x-api-key` header per request |
| **Endpoint** | `https://xquik.com/mcp` | `https://xquik.com/api/v1/*` |
| **Capabilities** | 21 tools (same core capabilities) | 30+ endpoints (finer control) |
...
- "How many followers does @burakbayir have?"
...
**Giveaways**
- "Pick 3 random winners from this tweet: https://x.com/burakbayir/status/1893456789012345678"
