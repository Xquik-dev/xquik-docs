...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 120 individual endpoints |
...
Works with 40+ AI coding agents including Claude Code, Cursor, GitHub Copilot, Codex, Windsurf, VS Code, Gemini CLI, and more. The skill covers MCP tools and 120 REST API endpoints.
