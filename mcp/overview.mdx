...
keywords: ["MCP", "model context protocol", "AI agents", "Claude", "ChatGPT", "Cursor", "VS Code", "Windsurf", "Codex", "OpenCode", "JetBrains", "server setup"]
---
...
<Tabs>
  ...
  <Tab title="ChatGPT">
    <Steps>
      <Step title="Enable developer mode">
        Open ChatGPT Desktop, go to **Settings > Connectors > Advanced settings**, and toggle on **Developer Mode**.
      </Step>
      <Step title="Add MCP server">
        Click **Add**, enter the server URL and the `x-api-key` header with your API key value:

        ```text
        https://xquik.com:3100/mcp
        ```
      </Step>
    </Steps>
  ...
  <Tab title="JetBrains">
    Go to **Settings > Tools > AI Assistant > Model Context Protocol (MCP)**, click **Add**, and enter:

    | Setting | Value |
    |---------|-------|
    | URL | `https://xquik.com:3100/mcp` |
    | Header name | `x-api-key` |
    | Header value | `xq_YOUR_KEY_HERE` |
  </Tab>
  <Tab title="OpenCode">
