...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 113 individual endpoints |
...
Works with 40+ AI coding agents including Claude Code, Cursor, GitHub Copilot, Codex, Windsurf, VS Code, Gemini CLI, and more. The skill covers MCP tools and 113 REST API endpoints.
