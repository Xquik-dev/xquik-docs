...
<Tip>**New to MCP?** Start with [Claude.ai](https://claude.ai) (zero config, OAuth login) or [Claude Code](/guides/frameworks/claude-code) (terminal, most flexible).</Tip>
...
Works with 40+ AI coding agents including Claude Code, Cursor, GitHub Copilot, Codex, Windsurf, VS Code, Gemini CLI, and more. The skill covers MCP tools and 122 REST API endpoints.
