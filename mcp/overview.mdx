...
interface EndpointInfo {
  ...
  path: string;
  summary: string;
  category: string; // account, bot, composition, extraction, integrations, media, monitoring, support, twitter, x-accounts, x-write
  free: boolean;
...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 99 individual endpoints |
