...
| `compose-tweet` | Start composing an algorithm-optimized tweet (free) |
| `refine-tweet` | Get targeted composition guidance (free) |
| `score-tweet` | Evaluate a draft tweet against algorithm factors (free) |
