...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 92 individual endpoints |
...
**Automations**
- "Create a flow that tweets whenever @elonmusk posts"
- "Set up a scheduled automation to check trends every hour"
- "Show me all my automation flows"
- "Add a like step to my monitor flow"
- "Create an AI compose flow that writes tweets from trending GitHub repos"
- "Set up a flow with a radar extraction step for Hacker News"
- "Use the ai-reply-machine template to auto-reply to mentions"
...
Works with 40+ AI coding agents including Claude Code, Cursor, GitHub Copilot, Codex, Windsurf, VS Code, Gemini CLI, and more. The skill covers MCP tools and 92 REST API endpoints.
