...
A guest `paid_reads` MCP session exposes exactly the [33 eligible paid-read routes](/guides/guest-wallets#eligible-paid-read-routes). It cannot execute writes or any other route.
