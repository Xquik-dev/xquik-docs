...
interface EndpointInfo {
  ...
  path: string;
  summary: string;
  category: string; // account, automations, bot, composition, extraction, integrations, media, monitoring, trends, twitter, x-accounts, x-write
  free: boolean;
  parameters?: Array<{
    name: string;
    in: 'query' | 'path' | 'body';
...
The server covers 92 endpoints across 12 categories:
...
| **trends** | 2 | Trending topics by region, trending by source |
