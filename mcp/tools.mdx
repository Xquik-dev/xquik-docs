...
| **twitter** | 17 | Tweet search, get tweet, get article, user lookup, follow check, trending topics, bookmarks, notifications, timeline, DM history, likes, media, favoriters, followers-you-know, user tweets |
