...
- A retweet ID on Get tweet thread returns the original post's thread
- A draw on a retweet URL reads the original post's replies & reposts
- The draw's `tweetId` names that original post
