...
- Search pages can end with `windowComplete: true` after a `sinceTime` bound
- It means the search read past that bound & found no more posts in the window
- Without it, the window may still hold posts
