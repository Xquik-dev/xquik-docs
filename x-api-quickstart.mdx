...
<Steps>
  ...
  <Step title="Create an account">
    ...
    Sign up at [xquik.com](https://xquik.com) with your email. You'll receive a magic link. No password is required.
  ...
  <Step title="Generate an API key">
    ...
    Open [API Keys](https://dashboard.xquik.com/en/account?tab=api-keys) in the dashboard and create a new key. Copy the full key immediately. The dashboard shows it once.
    ...
    <Warning>
      ...
      Store your API key securely. You cannot retrieve it after creation. Revoke and replace if compromised.
