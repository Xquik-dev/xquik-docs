...
<AccordionGroup>
  ...
  <Accordion title="Rate limited (429)">
    ...
    The fixed windows allow 300 reads per 1 second, 120 writes per 60 seconds, and 60 deletes per 60 seconds. Respect `Retry-After`. See [Rate Limits](/guides/rate-limits).
