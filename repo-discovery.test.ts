...
const REQUIRED_WEBHOOK_DELIVERIES_API_SNIPPETS = [
  ...
  "Other non-`2xx` responses and network failures stay `failed` until Xquik delivers them or they exhaust all attempts.",
...
const REQUIRED_WEBHOOK_OVERVIEW_SNIPPETS = [
  ...
  "The delay starts at 1 second, doubles each time, and caps at 60 seconds",
  "Final attempt. If it fails, Xquik marks the delivery `exhausted`.",
  "After the 10th failed attempt, Xquik marks the delivery `exhausted`.",
  "A `410 Gone` response exhausts the delivery immediately.",
  "Other non-`2xx` responses and network failures retry until Xquik exhausts the delivery.",
