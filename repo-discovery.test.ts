...
const REQUIRED_PIPEDREAM_GUIDE_SNIPPETS = [
  ...
  "For Pipedream data stores, map production `deliveryId` to `delivery_id` for receiver retry deduplication and `streamEventId` to `stream_event_id` when one monitor event should process once across endpoint changes.",
