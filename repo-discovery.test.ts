...
const REQUIRED_MCP_CONTRACT_SNIPPETS = [
  ...
  "Verify `X-Xquik-Signature`, deduplicate production payloads with `deliveryId` and `streamEventId`, and inspect `GET /api/v1/webhooks/{id}/deliveries` for retry status rows.",
