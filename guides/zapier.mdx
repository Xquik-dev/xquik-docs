...
This gives Zapier builders API-key auth, 113 REST endpoints, monitor webhooks, extraction jobs, and agent-adjacent workflows. The visible Zapier X templates are narrower: they focus on polling a query and taking one write action.
