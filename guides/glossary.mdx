...
<AccordionGroup>
  <Accordion title="Credits">
    The metered unit for API usage. Each operation costs 1-7 credits depending on the endpoint. Credits are included in your subscription and reset each billing period.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Write action">
    An operation that modifies X state — tweet, like, follow, DM, etc. Write actions cost 2 credits and require a connected X account.
  </Accordion>
</AccordionGroup>
