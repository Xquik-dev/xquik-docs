...
async def main():
    mcp_tool = MCPStreamableHTTPTool(
        ...
        description="X (Twitter) data platform with 111 API endpoints",
    )
...
The agent auto-discovers all Xquik tools (`explore` + `xquik`) and can call any of the 111 API endpoints.
