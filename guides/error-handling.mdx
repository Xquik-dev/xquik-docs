  ...
  <Accordion title="Conflict and cursor errors (409/410)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="coverage_cursor_unavailable" icon="timer">
        ...
        Preserve the cursor. Repeated busy responses never authorize a fresh extraction.
  ...
  <Accordion title="Server & service errors (500/502/503)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="pagination_stalled" icon="pause">
        ...
        Retrying the same cursor rarely helps (1 in 370 in production). Restart without a cursor. Deduplicate by ID.
