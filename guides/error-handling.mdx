  ...
  <Accordion title="Validation errors (400)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="invalid_tool_type" icon="database">
        ...
        Xquik does not recognize the extraction tool type. Use one of the 23 valid tool
      ...
      <Card title="too_many_ids" icon="list">
        ...
        The request has too many IDs. Split requests into groups of 100
        IDs or fewer.
      ...
      <Card title="invalid_idempotency_key" icon="key-round">
        ...
        The `Idempotency-Key` header does not match the endpoint's format. Send
        a random UUID v4, which every endpoint accepts.
  ...
  <Accordion title="Not found errors (404)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="tweet_not_found" icon="message-circle">
        ...
        Tweet ID does not resolve. Check the numeric tweet ID. The author may
  ...
  <Accordion title="Conflict and cursor errors (409/410)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="coverage_cursor_unavailable" icon="timer">
        ...
        Keep the cursor. Repeated busy responses never authorize a fresh extraction.
  ...
  <Accordion title="Server & service errors (500/502/503)">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="pagination_stalled" icon="pause">
        ...
        Retrying the same cursor worked 1 time in 370. Restart without a cursor. Deduplicate by ID.
      ...
      <Card title="x_write_failed" icon="circle-x">
        ...
        The write action failed. Follow `safeToRetry` and
