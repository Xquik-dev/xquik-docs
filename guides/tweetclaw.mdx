...
```bash
openclaw plugins install @xquik/tweetclaw@1.6.14 --pin
```

`@xquik/tweetclaw` is the official package. The plugin id is `tweetclaw`, and the current source-truth version is `1.6.14`.
