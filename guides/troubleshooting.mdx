...
- For the other 23 guest-eligible reads, authenticate or ask the user to confirm a guest wallet amount
...
- **Guest wallet.** Prepay 30 eligible GET routes through a confirmed USD 10 to 250 hosted checkout.
