...
<AccordionGroup>
  <Accordion title='Why am I getting 401 Unauthenticated?'>
    ...
    - **Key format:** Must start with `xqk_`. If it doesn't, you're using the wrong value.
  ...
  <Accordion title='How do I check my usage?'>
    ...
    - `capMicrocents`: Your monthly cap ($10 = 10,000,000,000 microcents)
    - `usedMicrocents`: How much you've consumed this period
    - **Remaining budget:** `capMicrocents - usedMicrocents`

    The dashboard also displays usage graphically on the billing page.

    See [Billing & Usage](/guides/billing) for cost-per-operation details and usage scenarios.
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Billing & Usage" icon="credit-card" href="/guides/billing">
    Pricing, usage caps, and cost-per-operation breakdown.
  </Card>
</CardGroup>
