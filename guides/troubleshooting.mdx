...
<AccordionGroup>
  ...
  <Accordion title='How do I connect an AI agent?'>
    Xquik provides an MCP (Model Context Protocol) server for AI agent integration. 38 tools are available at `https://xquik.com/mcp`.
    ...
    **Supported clients:**
    ...
    See the [MCP Server overview](/mcp/overview) for full setup instructions and the [MCP Tools](/mcp/tools) reference for all 38 tools.
  </Accordion>
