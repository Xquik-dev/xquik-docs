...
| Component | Role |
|-----------|------|
| **REST API** | 113 endpoints at `https://xquik.com/api/v1/*` for programmatic access |
...
| Aspect | Detail |
|--------|--------|
| **Subscription** | USD 20-199/month. Includes 1 monitor + monthly credit allowance |
| **Additional monitors** | USD 5/month each |
...
| **Monitor default** | 1 monitor included per subscription. Additional monitors cost USD 5/month each |
