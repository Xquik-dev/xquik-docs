...
description: Subscription tiers, per-operation credit costs, extra usage, and spending limits for the Xquik API
keywords: ["pricing", "subscription", "usage quota", "billing period", "credits", "cost"]
---
...
| Community join/leave | per call | 2 |
| [Create tweet](/api-reference/x-write/create-tweet) | per call | 2 |
| [Delete tweet](/api-reference/x-write/delete-tweet) | per call | 2 |
...
| [Follow](/api-reference/x-write/follow) | per call | 2 |
| [Follow check](/api-reference/x/check-follower) | per call | 7 |
| [Followers you know](/api-reference/x/followers-you-know) | per result | 1 |
| [Get article](/api-reference/x/get-article) | per call | 7 |
| [Get tweet](/api-reference/x/get-tweet) | per call | 1 |
| [Get user](/api-reference/x/get-user) | per call | 2 |
| [Like](/api-reference/x-write/like) | per call | 2 |
| [Notifications](/api-reference/x/notifications) | per result | 1 |
| [Retweet](/api-reference/x-write/retweet) | per call | 2 |
| [Search tweets](/api-reference/x/search-tweets) | per tweet returned | 1 |
| [Send DM](/api-reference/x-write/send-dm) | per call | 2 |
| [Timeline](/api-reference/x/timeline) | per result | 1 |
| [Trends](/api-reference/x/trends) | per call | 3 |
| [Unfollow](/api-reference/x-write/unfollow) | per call | 2 |
| [Unlike](/api-reference/x-write/unlike) | per call | 2 |
| [Unretweet](/api-reference/x-write/unretweet) | per call | 2 |
| [Upload media](/api-reference/x-write/upload-media) | per call | 2 |
...
| [Verified followers](/api-reference/x/verified-followers) | per result | 2 |
