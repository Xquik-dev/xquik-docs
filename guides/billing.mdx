...
<AccordionGroup>
  <Accordion title="What happens when I run out of credits?">
    Metered calls return `402 Payment Required`. Non-metered operations (monitors, webhooks, integrations, account) continue working. [Top up credits](/api-reference/credits/topup) from the dashboard to continue.
  </Accordion>
