...
Seven fixed-price read operations accept direct [MPP](/mpp/machine-payments-protocol) payments. You need no subscription. Media downloads require full account authentication because they create account-tied gallery links.
