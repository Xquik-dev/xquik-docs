...
| [Favoriters](/api-reference/x/favoriters) | per result | 2 |
| [Follow](/api-reference/x-write/follow) | per call | 10 |
| [Follow check](/api-reference/x/check-follower) | per call | 5 |
| [Followers you know](/api-reference/x/followers-you-know) | per result | 2 |
...
| 2 per result | Followers, following, favoriters, retweeters, community members, people search, list members, list followers, verified followers |
