...
Connect your AI agent or IDE to the Xquik MCP server. See the [MCP setup guide](/mcp/overview#setup) for configuration instructions for Claude Desktop, Claude Code, ChatGPT, Codex CLI, Cursor, VS Code, Windsurf, JetBrains, and OpenCode.
