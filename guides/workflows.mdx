...
|---------|----------|-----------|-------------|
| [Monitor & poll](#1-monitor--poll) | Batch processing, dashboards, low-frequency checks | No (interval-based) | Low |
| [Real-time webhooks](#2-real-time-webhooks) | Instant notifications, event-driven pipelines | Yes | Medium |
| [AI agent (MCP)](#3-ai-agent-mcp) | Natural language queries, conversational analysis | Yes | Low |
| [Tweet composition](#4-tweet-composition) | Algorithm-optimized drafts, content workflows | N/A | Low |
