...
<Tabs>
  <Tab title="Monitor & poll">
    Batch processing, dashboards, low-frequency checks. [Jump to section](#1-monitor--poll)
  </Tab>
  <Tab title="Real-time webhooks">
    Instant notifications, event-driven pipelines. [Jump to section](#2-real-time-webhooks)
  </Tab>
  <Tab title="AI agent (MCP)">
    Natural language queries, conversational analysis. [Jump to section](#3-ai-agent-mcp)
  </Tab>
  <Tab title="Tweet composition">
    Algorithm-optimized drafts, content workflows. [Jump to section](#4-tweet-composition)
  </Tab>
</Tabs>
