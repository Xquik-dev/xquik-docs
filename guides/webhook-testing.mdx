...
keywords: ["webhook testing", "ngrok", "local development", "signature verification", "webhook.site"]
---
...
Test all event types by changing the `eventType` field: `tweet.new`, `tweet.reply`, `tweet.quote`, `tweet.retweet`, `follower.gained`, `follower.lost`.
