...
<AccordionGroup>
  ...
  <Accordion title="Getting 402 error">
    Creating extractions, draws, and media downloads requires an active subscription. Listing existing extractions, draws, monitors, events, and webhooks works without a subscription. Free endpoints include compose, styles, drafts, radar, account, API keys, credit balance, and credit top-ups. Check your account status via [Get Account](/api-reference/account/get).
  </Accordion>
