...
<Steps>
  ...
  <Step title="Subscribe">
    ...
    Xquik requires an active subscription ($20/month) to access the API. Subscribe from the dashboard billing page. Your plan includes a monthly credit allowance.
  </Step>
