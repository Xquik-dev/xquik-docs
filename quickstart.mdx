...
<AccordionGroup>
  ...
  <Accordion title="Getting 402 error">
    Creating extractions, draws, and monitors (plus media downloads) requires an active subscription. All webhook operations (create, read, update, delete, deliveries, test) are free. Reading, updating, deleting, exporting, and testing existing extractions, draws, monitors, and events is also free. Other free endpoints include compose, styles, drafts, radar, account, API keys, credit balance, and credit top-ups. Check your account status via [Get Account](/api-reference/account/get).
  </Accordion>
