...
<AccordionGroup>
  ...
  <Accordion title="Getting 402 error">
    Creating extractions, draws, and monitors (plus media downloads) requires an active subscription. Reading, updating, deleting, exporting, and testing existing extractions, draws, monitors, events, and webhooks is free. Free endpoints also include compose, styles, drafts, radar, account, API keys, credit balance, and credit top-ups. Check your account status via [Get Account](/api-reference/account/get).
  </Accordion>
