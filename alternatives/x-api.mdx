...
X's official overview describes the X API as programmatic access to public conversation, with capabilities for reading posts, publishing content, managing users, analyzing metrics and trends, sending DMs, managing lists, and working with Spaces. The same overview recommends X API v2 for new projects.
