...
| Export profile data and related timelines                                                                          | Run `xquik/x-profile-scraper`     | Profile, tweet, media, follower, and following rows                                                  | You need separate endpoint calls or per-resource pagination control                                                     |
